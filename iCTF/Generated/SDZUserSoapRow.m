/*
	SDZUserSoapRow.h
	The implementation of properties and methods for the SDZUserSoapRow object.
	Generated by SudzC.com
*/
#import "SDZUserSoapRow.h"

@implementation SDZUserSoapRow
	...
	+ (SDZUserSoapRow*) newWithNode: (CXMLNode*) node
	{
		...
		return (SDZUserSoapRow*)[[[SDZUserSoapRow alloc] initWithNode: node] autorelease];
	}
	...
	{
		return [self serialize: @"UserSoapRow"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[SDZUserSoapRow class]]) {
