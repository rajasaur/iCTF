/*
	...
	The implementation of properties and methods for the SDZProjectGroupMemberSoapRow object.
	Generated by SudzC.com
*/
#import "SDZProjectGroupMemberSoapRow.h"

@implementation SDZProjectGroupMemberSoapRow
	...
	+ (SDZProjectGroupMemberSoapRow*) newWithNode: (CXMLNode*) node
	{
		...
		return (SDZProjectGroupMemberSoapRow*)[[[SDZProjectGroupMemberSoapRow alloc] initWithNode: node] autorelease];
	}
	...
	{
		return [self serialize: @"ProjectGroupMemberSoapRow"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[SDZProjectGroupMemberSoapRow class]]) {
